...
# Files to exclude from extraction (The app itself and your main landing page)
...
def main():
    ...
    for root, dirs, files in os.walk(ROOT_DIR):
        ...
        for file in files:
            if file.endswith(".html") and file not in EXCLUDE_FILES:
                ...
                if tests:
                    print(f"Found {len(tests)} tests in: {full_path}")
    ...
    print(f"Extracted {len(all_quizzes)} total tests.")
    print("="*50)
